...
if CHROME_INSTANCE_PATH:
    expected_browser = Browser(
        # config=BrowserConfig(chrome_instance_path=CHROME_INSTANCE_PATH, headless=False)
        config=BrowserConfig(chrome_instance_path="/usr/bin/chromium-browser", headless=False)
    )
